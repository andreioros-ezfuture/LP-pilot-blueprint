  ...
  return (
    <SectionWrapper id="garantie" variant="light" maxWidth="standard">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        {/* Card 1 - Money Back */}
        <FadeInOnScroll>
          <div className="border-2 border-success rounded-2xl p-8 bg-white h-full flex flex-col">
            ...
            <div className="mt-6">
              <Badge variant="success">100% money back garantat</Badge>
            </div>
          </div>
        </FadeInOnScroll>
        ...
        <FadeInOnScroll delay={100}>
          <div className="border-2 border-warning rounded-2xl p-8 bg-white h-full flex flex-col">
            <div className="text-4xl mb-4">
            ...
            <div className="mt-6">
              <Badge variant="warning">€3.750 credit catre implementare</Badge>
            </div>
          </div>
        </FadeInOnScroll>
      </div>
